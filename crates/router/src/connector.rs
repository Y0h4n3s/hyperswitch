...
pub use self::{
    ...
    payeezy::Payeezy, payme::Payme, paypal::Paypal, payrabbit::Payrabbit, payu::Payu,
    powertranz::Powertranz, prophetpay::Prophetpay, rapyd::Rapyd, shift4::Shift4, square::Square,
